...
institution: "（待补充）"
conf: arXiv
keywords: [cross-embodiment, dexterous manipulation, history-conditioned transformer, zero-shot transfer]
tags: [跨载体泛化, 灵巧操作, 表征学习]
summary: "利用历史条件 Transformer 隐式推断不同手型与动力学差异，实现零样本跨灵巧手泛化。"
domain: 具身智能
pdf_path: ""
reading_date: 2026-04-09
reading_status: 已读
related_concepts: [跨载体泛化, 灵巧操作, 表征学习]
---
