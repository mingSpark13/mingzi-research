...
institution: Unknown
conf: arXiv
keywords: [video diffusion, geometry consistency, policy transfer, data augmentation]
tags: ["数据合成", "视频生成", "Sim2Real", "零样本泛化"]
summary: "用几何一致性视频扩散把机器人操作视频做成可控可编辑的数据增强层，并在策略迁移中带来显著真实泛化增益。"
domain: 数据飞轮
pdf_path: ""
reading_date: 2026-04-09
reading_status: 摘要级深挖
related_concepts: ["数据合成", "视频生成", "Sim2Real", "零样本泛化"]
---
...
## 对主人的落地启发
1. 可把 RoboTransfer 作为 D05 的 **geometry-consistent augmentation layer**，接在 UE/AirSim 场景导出之后。
